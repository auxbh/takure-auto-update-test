...
impl Logger {
    pub fn new() -> Self {
        Self {
            file: File::create("takure.log").unwrap(),
        }
    }
}
...
pub(crate) fn colored_level(
    ...
    level: log::Level,
) -> env_logger::fmt::StyledValue<'_, &'static str> {
    match level {
        log::Level::Trace => style.set_color(env_logger::fmt::Color::Magenta).value("TRACE"),
        ...
        log::Level::Warn => style.set_color(env_logger::fmt::Color::Yellow).value("WARN"),
